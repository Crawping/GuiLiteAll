...
void create_page_config(c_slide_group* group)
{
	...
	s_patient_setup_dlg.assemble(&s_root, IDD_SETUP_DLG,STR_SETUP_DLG_TITLE, 0, DIALOG_Y, PAGE_WIDTH, DIALOG_HEIGHT, g_patient_setup_children);
	s_about.assemble(&s_root, IDD_ABOUT_DLG,STR_ABOUT_SOFTWARE, 0, DIALOG_Y, PAGE_WIDTH, DIALOG_HEIGHT,g_about_children);
...
void create_clone_page_config(c_slide_group* group)
{
	...
	c_dialog* dlg = (c_dialog*)s_patient_setup_dlg.assemble_clone(page_config,IDD_SETUP_DLG,STR_SETUP_DLG_TITLE,0, DIALOG_Y, PAGE_WIDTH, DIALOG_HEIGHT, g_patient_setup_children);
	s_about.assemble_clone(page_config, IDD_ABOUT_DLG, STR_ABOUT_SOFTWARE, 0, DIALOG_Y, PAGE_WIDTH, DIALOG_HEIGHT,g_about_children);
