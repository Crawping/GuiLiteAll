...
void load_ui_single(void* phy_fb)
{
	...
	s_root.assemble(NULL, ID_ROOT, 0, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, s_root_children);
...
void load_ui_multi(void* phy_fb)
{
	...
	surface->set_active(true);
	s_root.set_surface(surface);
	c_wnd* root = s_root.assemble_clone(NULL, ID_ROOT, 0, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, s_root_children);
...
void load_mini_ui_single(void* phy_fb)
{
	...
	s_mini_root.assemble(NULL, ID_ROOT, 0, 0, 0, MINI_SCREEN_WIDTH, MINI_SCREEN_HEIGHT, s_mini_root_children);
...
void load_mini_ui_multi(void* phy_fb)
{
	...
	surface->set_active(true);
	s_mini_root.set_surface(surface);
	c_wnd* root = s_mini_root.assemble_clone(NULL, ID_ROOT, 0, 0, 0, MINI_SCREEN_WIDTH, MINI_SCREEN_HEIGHT, s_mini_root_children);
